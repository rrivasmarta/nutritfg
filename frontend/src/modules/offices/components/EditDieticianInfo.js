...
class EditDieticianInfo extends React.Component {
    ...
    updateProfile() {
        ...
        this.props.updateProfile(
            ...
            () => this.props.history.push(`/offices/info-dietician/${this.props.match.params.id}/withBackLink`),
...
const mapDispatchToProps = {
    updateProfile: actions.updateProfileDietician,
    getGenres: appActions.getGenres,
    findDieticianById: actions.findDieticianById
};

export default connect(mapStateToProps, mapDispatchToProps)(EditDieticianInfo);