...
class ChangePasswordO extends React.Component {
...
const mapStateToProps = (state) => ({
    id: selectors.getDieticianOffice(state).id
});
...
export default connect(mapStateToProps, mapDispatchToProps)(ChangePasswordO);
